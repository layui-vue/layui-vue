<template>
  <lay-config-provider :locale="locale" :locales="locales" :theme="appStore.theme"
    :themeVariable="appStore.themeVariable">
    <lay-layout class="layui-layout-document" style="height: 100%">
      <lay-header>
        <lay-logo>
          <img src="../assets/logo-png.png" /><span style="
              margin-left: 12px;
              font-size: 20px;
        ...
        <ul class="layui-nav layui-layout-left" style="margin-top: 0px; margin-bottom: 0px">
        ...
        <ul class="layui-nav layui-layout-right" style="margin-top: 0px; margin-bottom: 0px">
          <li class="layui-nav-item">
            <lay-dropdown>
              <a href="javascript:void(0);">
                <lay-icon size="15px" type="layui-icon-theme" style="padding-left: 30px; padding-right: 30px">
                </lay-icon>
              </a>
              <template #content>
                <div style="width: 380px; padding: 0px 10px 10px 10px">
                  <lay-color-picker v-model="appStore.themeVariable['--global-primary-color']"></lay-color-picker>&nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-normal-color']"></lay-color-picker>&nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-warm-color']"></lay-color-picker>&nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-danger-color']"></lay-color-picker>&nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-checked-color']"></lay-color-picker>&nbsp;
                  <lay-input v-model="appStore.themeVariable['--global-border-radius']"
                    style="display: inline-block; width: 130px"></lay-input>
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-1']"></lay-color-picker>
                  &nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-2']"></lay-color-picker>
                  &nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-3']"></lay-color-picker>
                  &nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-4']"></lay-color-picker>
                  &nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-5']"></lay-color-picker>
                  &nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-6']"></lay-color-picker>
                  &nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-7']"></lay-color-picker>
                  &nbsp;
                  <lay-color-picker v-model="appStore.themeVariable['--global-neutral-color-8']"></lay-color-picker>
                </div>
              </template>
            </lay-dropdown>
          </li>
          ...
          <li class="layui-nav-item">
            <a href="javascript:void(0)">
              <lay-badge type="rim" class="layui-local-badge" v-if="locale === 'en_US'" @click="changeLocale('zh_CN')">中
                文</lay-badge>
          ...
          <li class="layui-nav-item">
            <a href="javascript:void(0)">
              <lay-switch v-model="appStore.theme" class="switch" onswitch-value="dark" unswitch-value="light"
                onswitch-color="rgba(255, 255, 255, 0.05)" unswitch-color="rgba(255, 255, 255, 0.05)">
                <template #onswitch-icon>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="rgba(60, 60, 60, .7)" aria-hidden="true"
                    focusable="false" viewBox="0 0 24 24" class="vt-switch-appearance-moon">
                    <path
