export default [
  ...
  { name: "清空删除", class: "layui-icon-clear" },
  { name: "键盘", class: "layui-icon-keyboard" },
  { name: "退格", class: "layui-icon-backspace" },
  { name: "显示密码", class: "layui-icon-show" },
  { name: "隐藏密码", class: "layui-icon-hide" },
  { name: "错误", class: "layui-icon-error" },
  { name: "成功", class: "layui-icon-success" },
  { name: "疑问", class: "layui-icon-question" },
  { name: "锁定", class: "layui-icon-lock" },
  { name: "月亮", class: "layui-icon-moon" },
  { name: "Github", class: "layui-icon-github" },
  { name: "禁用", class: "layui-icon-disabled" },
  { name: "Gitee", class: "layui-icon-gitee" },
