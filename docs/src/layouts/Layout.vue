...
import menusData from "../view/utils/menus";
...
menusData.forEach((m) => {
  const menuChildren = [...(m.children || [])].sort((a, b) => a.subTitle.localeCompare(b.subTitle));
...
<template>
  <lay-config-provider
    ...
    :theme-variable="appStore.themeVariable"
  >
